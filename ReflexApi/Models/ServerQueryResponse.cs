...
namespace ReflexAPI.Models
{
    ...
    public class ServerQueryResponse
    {
        ...
        /// </summary>
        /// <value>The servers that failed to query.</value>
        ...
        /// <summary>
        /// Gets or sets the number of servers that were skipped due to being unindexed (not
        /// contained in our master server list).
        /// </summary>
        /// <value>The number of servers that were skipped due to being unindexed.</value>

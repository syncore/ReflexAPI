...
namespace ReflexAPI.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// The PrivateQuery is intended for testing purposes and trusted users. Ignore ReSharper
    /// warnings about capitalization since JSON responses are not typically capitalized in APIs.
    /// </remarks>
